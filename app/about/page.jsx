      ...
      >
        <p>
          <span style={{ color: "#8A2BE2" }}>
            Web3Kerala is a vibrant community focused on connecting individuals
            in the Web3 space across Kerala.
          </span>{" "}
          The community aims to provide education, resources, and networking
          opportunities to foster growth and innovation in the decentralized web
          space. Members come from diverse backgrounds, including crypto
          enthusiasts, developers, artists, and entrepreneurs, all united by a
          shared interest in Web3 technologies.
        </p>
      </div>
      <motion.div
        style={{
      ...
      <style jsx>{`
        ...
        .heading::before {
          ...
          box-shadow: 220px 118px #fff, 280px 176px #fff, 40px 50px #fff,
            60px 180px #fff, 120px 130px #fff, 180px 176px #fff,
            220px 290px #fff, 520px 250px #fff, 400px 220px #fff,
        ...
        .icons::before {
          ...
          box-shadow: 140px 20px #fff, 425px 20px #fff, 70px 120px #fff,
            ...
            280px 230px #fff, 220px 190px #fff, 450px 100px #fff,
            380px 80px #fff, 520px 50px #fff;
          z-index: -1;
        ...
        .icons::after {
          ...
          box-shadow: 490px 330px #fff, 420px 300px #fff, 320px 280px #fff,
            380px 350px #fff, 546px 170px #fff, 420px 180px #fff,
            370px 150px #fff, 200px 250px #fff, 80px 20px #fff, 190px 50px #fff,
            270px 20px #fff, 120px 230px #fff, 350px -1px #fff, 150px 369px #fff;
          z-index: -1;
          transition: 2s ease;
          animation: 1s glowing-stars linear alternate infinite;
