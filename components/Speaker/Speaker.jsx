    ...
    <>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-40 px-4 md:px-12 lg:px-16 xl:px-24 py-8 mx-auto my-8 md:my-12 lg:my-16">
        <div className="card">
          ...
          <h2>W3Hidayath</h2>
          <div className="icons">
            <a href="https://x.com/W3Hidayath" className="x">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
        ...
        <div className="card">
          ...
          <div className="icons">
            <a href="https://x.com/srinigoes" className="x">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
        ...
        <div className="card">
          <img
            ...
            className="image"
          />
          <a className="text-blue-500" href="/bitroot">BITROOT(Not Human)</a>
          <div className="icons">
            <a href="https://x.com/cryptoswami69" className="x">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
